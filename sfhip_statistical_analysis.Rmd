...
(1) counted the number of venues using each of the license types within each census
tract, then divided by the population of that census tract and (2) counted
the number of crimes within each of the general description groups . Further, 
we discarded those tracts with fewer than 500 people living within them, since
